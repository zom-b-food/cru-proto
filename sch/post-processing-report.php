						...
						<div class="report-wrapper">
							...
							<table class="table-cru tight">
								<thead class="thead-cru">
									<tr class="first">
										<th scope="col" style="width:10%;border-bottom:none;">DX's/PX's/NDC's
											P/L</th>
										<th scope="col" style="width:8%;border-bottom:none;">Unt/Qty</th>
										<th scope="col" style="width:9%;border-bottom:none;">Total Chg</th>
										<th scope="col" style="width:9%;border-bottom:none;">Total AA</th>
										<th scope="col" style="width:9%;border-bottom:none;">Mcaid</th>
										<th scope="col"
											style="width:9%; white-space:nowrap; border-bottom:none;">OHI #1
											PD</th>
										<th scope="col"
											style="width:9%; white-space:nowrap; border-bottom:none;">OHI #1
											PR</th>
										<th scope="col"
											style="width:6%; border-right:none; padding-left:14px; border-bottom:none;">
											Deduct</th>
										<th scope="col" style="width:1%;border-bottom:none;"></th>
										<th scope="col" style="width:9%;border-bottom:none;">Payments</th>
										<th scope="col" style="width:3%;border-bottom:none;">AI</th>
										<th scope="col" style="width:28%;border-bottom:none;">Reason</th>
									</tr>
									<tr class="second">
										<th scope="col"></th>
