            ...
            <div class="row">
                ...
                <div class="col-9">
                    <div class="row header">
                        ...
                        <div class="row mt15">
                            <small>
                                <a class="btn btn-back" role="button" href="/bc/bc-landing-page.php" tabindex=1>&nbsp;
                            ...
                            <div class="col-12">
                                <form>
                                    <div class="row float-right">
                                        ...
                                        <input type="text" class="daterange" placeholder="Date Range From"><input
                                            type="text" class="daterange" placeholder="Date Range To">
                                ...
                                <table class="table-sort">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="setwidth-15 table-sort" scope="col">Description</th>
                                            ...
                                            <th class="setwidth-25" scope="col">Comments</th>
                                            <th class="setwidth-3" scope="col">&nbsp;</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td><input type="checkbox" name="pxcode" id="zero" class="checkbox"></td>
                                            <td>002457Z</td>
                                        ...
                                        <tr>
                                            <td><input type="checkbox" name="pxcode" id="one" class="checkbox"></td>
                                            <td>5400124</td>
                                        ...
                                        <tr>
                                            <td><input type="checkbox" name="pxcode" id="two" class="checkbox"></td>
                                            <td>0025486</td>
                                        ...
                                        <tr>
                                            <td><input type="checkbox" name="pxcode" id="three" class="checkbox"></td>
                                            <td>845510Z</td>
                                        ...
                                        <tr>
                                            <td><input type="checkbox" name="pxcode" id="four" class="checkbox"></td>
                                            <td>6060224</td>
                                        ...
                                        <tr>
                                            <td><input type="checkbox" name="pxcode" id="five" class="checkbox"></td>
                                            <td>9000548</td>
                                        ...
                                        <tr>
                                            <td><input type="checkbox" name="pxcode" id="six" class="checkbox"></td>
                                            <td>5W8541Z</td>
                                        ...
                                        <tr>
                                            <td><input type="checkbox" name="pxcode" id="seven" class="checkbox"></td>
                                            <td>8740W4Z</td>
                                        ...
                                        <tr>
                                            <td><input type="checkbox" name="pxcode" id="eight" class="checkbox"></td>
                                            <td>0155554</td>
                                        ...
                                        <tr>
                                            <td><input type="checkbox" name="pxcode" id="nine" class="checkbox"></td>
                                            <td>2W55021</td>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            ...
                                                            <input type="text" class="form-control" id="ed"
                                                                placeholder="01/01/2019" name="ed">
                                                        </div>
                                                        <div class="col">
                                                            <label for="ind">Inctive Date </label>
                                                            <input type="text" class="form-control" id="ind"
                                                                placeholder="Enter Date" name="ind">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col">
                                                            <label for "comment" style="margin-top:.5rem;">Comment <span
                                                                    class="red">*</span></label>
                                            ...
                                            <div class="modal-footer-left">
                                                <button type="button"
                                                    class="btn btn-save mr10">Save</button>&nbsp;<button type="button"
                                                    class="btn btn-success mr10">Approve</button><button type="button"
                                                    class="btn btn-cancel mr10" style="float:right;"
